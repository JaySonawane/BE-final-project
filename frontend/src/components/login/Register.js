...
const Register = () => {
    ...
    <div class='background'>
        ...
        <div className="ui container">
            <div className="ui centered card" style={{width:'522px' ,paddingLeft:'22px',paddingRight:'22px',paddingTop: '20px',height: '490px'}}>
                <form method="POST" className="form-card ui form custom-width" >
                    <div className="ui grid">
                        ...
                        <button className="ui fluid button" style={{width:'480px',marginLeft:'15px'}} type="submit" onClick={onClickRegister}>Register</button>
